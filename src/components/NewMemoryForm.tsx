...
export function NewMemoryForm() {
    ...
    async function handleCreateMemory(event: FormEvent<HTMLFormElement>) {
        ...
        await api.post('/memories', { coverUrl, content: formData.get('content'), isPublic: formData.get('isPublic') }, { headers: { Authorization: `Bearer ${token}` } }
    ...
    return (
        ...
        <form onSubmit={handleCreateMemory} className="flex flex-1 flex-col gap-2">
            ...
            <button type="submit" className="inline-block self-end rounded-full bg-green-500 px-5 py-3 font-alt text-sm uppercase leading-none text-black hover:bg-green-700" >Salvar</button>
